...
<div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <a href="{{ route('teacher.attendance') }}" class="btn btn-outline-secondary btn-sm"><i class="fas fa-arrow-left me-1"></i> Back to Attendance</a>
</div>
        ...
        <form method="POST" action="{{ route('teacher.attendance.store') }}" id="attendanceForm">
            ...
            <div id="studentsContainer" style="display: none;">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    <h6 class="fw-bold mb-0"><i class="fas fa-users me-1"></i>Students</h6>
...
document.getElementById('loadStudents').addEventListener('click', function() {
    ...
    fetch('{{ url("teacher/api/students-by-class") }}/' + classId)
