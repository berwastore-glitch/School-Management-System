...
<div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <a href="{{ route('teacher.students.show', $student) }}" class="btn btn-outline-secondary btn-sm"><i class="fas fa-arrow-left me-1"></i>Back</a>
</div>
...
<div class="row g-4">
                                ...
                                <tr data-term="{{ $result->term ?? '' }}">
                                    ...
                                    <td>
                                        <div class="d-flex gap-1">
                                            ...
                                            <form action="{{ route('teacher.students.marks.remove', [$student, $result]) }}" method="POST" onsubmit="return confirm('Remove this exam?')">
                                                @csrf @method('DELETE')
    ...
    <div class="col-12">
        <div class="card border-0 shadow-sm">
            ...
            <div class="card-body">
                <form method="POST" action="{{ route('teacher.students.marks.store', $student) }}">
                    @csrf
