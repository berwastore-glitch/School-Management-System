...
<div class="d-flex justify-content-between align-items-center mb-4">
    <div>
        <form method="GET" class="d-flex gap-2">
            ...
            @if(request('search'))<a href="{{ route('teacher.subjects') }}" class="btn btn-outline-secondary"><i class="fas fa-times"></i></a>@endif
        </form>
    </div>
    <a href="{{ route('teacher.subjects.create') }}" class="btn btn-orange"><i class="fas fa-plus me-1"></i>Add Subject</a>
</div>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="btn-group btn-group-sm">
                                <a href="{{ route('teacher.subjects.edit', $subject) }}" class="btn btn-warning" title="Edit"><i class="fas fa-edit"></i></a>
                                <form action="{{ route('teacher.subjects.destroy', $subject) }}" method="POST" class="d-inline" onsubmit="return confirm('Are you sure you want to delete this subject?')">
                                    @csrf @method('DELETE')
